...
const IMAGE_DEFAULT = `สร้าง prompt ภาษาอังกฤษสำหรับ Gemini เพื่อทำภาพประกอบบทความ "{{title}}" (หัวข้อ: {{keyword}})

สไตล์กลาง (ทีมปรับได้):
- Photorealistic editorial photography คุณภาพนิตยสาร
- แสงธรรมชาติ/softbox นุ่ม องค์ประกอบ rule of thirds มี depth of field
- บุคคล/สินค้า/บรรยากาศแบบไทย-เอเชียเมื่อเกี่ยวข้องกับหัวข้อ
- โทนสีสอดคล้อง {{accent_color}} แบบไม่จัดจ้าน
- ภาพต้องสื่อถึง "{{keyword}}" ตรงๆ ไม่ใช่ภาพ stock ทั่วไป

ข้อห้ามเด็ดขาด:
- ห้ามมีตัวอักษร ตัวเลข โลโก้ ลายน้ำ หรือ infographic บนภาพ
- ห้าม before/after · ห้ามภาพหลอกลวงผลลัพธ์
- ปีปัจจุบัน: สไตล์และของประกอบฉากต้องร่วมสมัย`
