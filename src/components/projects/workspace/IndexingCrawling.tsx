...
/**
 * Indexing & Crawling — หน้าเดียวกับ On-Page SEO / Technical SEO
 *
 * ใช้ SeoTaskChecklist ตัวเดียวกัน เปลี่ยนแค่ area + ชุดหมวด
 * งานถูกเก็บใน SeoTask (area = "INDEXING") จึงไม่ปนกับสองหน้าเดิม
 */
...
export function IndexingCrawling({ project, userRole }: Props) {
  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
        <div>
          <h2 className="text-lg font-semibold text-brand-navy">Indexing &amp; Crawling</h2>
